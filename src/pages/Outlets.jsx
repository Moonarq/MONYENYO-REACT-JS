...
const Outlets = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Our Outlet - Monyenyo</title>
      ...
      <div className="outlets-page">
          ...
          <section className="hero-section">
            <div className="container">
              <div className="hero-content">
                ...
                <h1 className="hero-title">{t('Visit Monyenyo Bandung')}</h1>
                <p className="hero-subtitle">
                  {t('Experience authentic Indonesian brownies in our modern flagship store located in the heart of Bandung')}
                </p>
                <div className="hero-cta">
                  <a 
                    href="https://www.google.com/maps?q=Jl.+Terusan+Gatot+Subroto+No.302,+Kb.+Kangkung,+Kec.+Kiaracondong,+Kota+Bandung,+Jawa+Barat+40284" 
        ...
        <div className="whatsapp-float">
          <a href="https://wa.me/6282295029308" target="_blank" rel="noopener">
            <img 
